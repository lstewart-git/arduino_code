...
if (alt >99){                                       //  check for negative values, replace leading spaces with minus sign 
...
if (alt < -99){  
num1 =45;}                     // convert the int values to their corresponding ascii values
else {num1 = 32;
num2 = num2 + asciiConvert;}

if (alt < -9){                                       //  check for negative values, replace leading spaces with minus sign 
num2 = 45;
num3 = num3 + asciiConvert;}
else {
num2 = 32;
...
else if(minaltitude < -99){
  minnum1 = 45;
  minnum2 = minnum2 + asciiConvert;}

else if(minaltitude < -9){
  minnum1 = 32;
  minnum2 = 45;
